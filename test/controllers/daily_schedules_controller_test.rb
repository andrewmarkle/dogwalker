...
class DailySchedulesControllerTest < ActionController::TestCase
  ...
  test "should create daily_schedule" do
    assert_difference('DailySchedule.count') do
      post :create, daily_schedule: { date_and_time: @daily_schedule.date_and_time, dog_name: @daily_schedule.dog_name, people_name: @daily_schedule.people_name }
    end
  ...
  test "should update daily_schedule" do
    patch :update, id: @daily_schedule, daily_schedule: { date_and_time: @daily_schedule.date_and_time, dog_name: @daily_schedule.dog_name, people_name: @daily_schedule.people_name }
    assert_redirected_to daily_schedule_path(assigns(:daily_schedule))
  end
